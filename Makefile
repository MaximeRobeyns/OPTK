...
TEST_OBJECTS_i	= $(patsubst ${TESTSRC}/%,${TESTBUILDDIR}/%,${TEST_SOURCES:.cpp=.o})
TEST_OBJECTS_ii	= $(patsubst ${SOURCES}/%,${TESTBUILDDIR}/%,${PROJECT_SOURCES:.cpp=.o})
...
# test compilation
${TESTBUILDDIR}/%.o: ${SOURCES}/%.cpp ${TESTSRC}/%.cpp
	mkdir -p $(dir $@)
