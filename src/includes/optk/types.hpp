...
class param_t {
    public:
        ...
        std::string m_name;
        optk::param_type get_type() { return type; }

    private:
        optk::param_type type;
};
...
class choice: param_t {
    ...
    private:
        ...
        optk::param_type type = optk::choice;
};
...
class randint: param_t {
    ...
    private:
        optk::param_type type = optk::randint;
};
...
class uniform: param_t {
    ...
    private:
        optk::param_type type = optk::uniform;
};
...
class quniform: param_t {
    ...
    private:
        optk::param_type type = optk::quniform;
};
...
class loguniform: param_t {
    ...
    private:
        optk::param_type type = optk::loguniform;
};
...
class qloguniform: param_t {
    ...
    private:
        optk::param_type type = optk::qloguniform;
};
...
class normal: param_t {
    ...
    private:
        optk::param_type type = optk::normal;
};
...
class qnormal: param_t {
    ...
    private:
        optk::param_type type = optk::qnormal;
};
...
class lognormal: param_t {
    ...
    private:
        optk::param_type type = optk::lognormal;
};
...
class qlognormal: param_t {
    ...
    private:
        optk::param_type type = optk::qlognormal;
};
